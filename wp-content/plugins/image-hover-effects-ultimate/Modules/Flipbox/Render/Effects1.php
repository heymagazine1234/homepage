    ...
    public function default_render($style, $child, $admin)
    {
        ...
        foreach ($child as $val) {
            ...
            if ($this->media_background_render('image_hover_front_image', $value) != '') :
                ...
                $this->inline_css .= '.' . $this->WRAPPER . ' .oxi-image-flipbox-hover-' . $this->oxiid . '-' . $val['id'] . ' .oxi-image-hover-figure-frontend:after{background: url(' . $url . ' !important);-moz-background-size: 100% 100%;-o-background-size: 100% 100%; background-size: 100% 100%;}';
            endif;
            if ($this->media_background_render('image_hover_back_image', $value) != '') :
                ...
                $this->inline_css .= '.' . $this->WRAPPER . ' .oxi-image-flipbox-hover-' . $this->oxiid . '-' . $val['id'] . ' .oxi-image-hover-figure-backend:after{background: url(' . $url . ' !important);-moz-background-size: 100% 100%;-o-background-size: 100% 100%; background-size: 100% 100%;}';
            endif;
            echo ' </div>';
        }
    }
